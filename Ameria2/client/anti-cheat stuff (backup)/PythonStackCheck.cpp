...
void CPythonStackController::SendViolationMessage(int iTypeId, const std::string & szRefFileName, const std::string & szRefFuncName)
{
#ifdef _DEBUG
...
void CPythonStackController::CheckStackReferenceEx(int iTypeId, const std::string & szRefFileName, const std::string & szRefFuncName)
{
...
void CPythonStackController::CheckStackReference(int iTypeId, const std::string & szRefFileName, const std::string & szRefFuncName)
{
	...
	{
#ifdef _DEBUG
		TraceError("CPythonStackController::IsAllowedReference - Type: '%d' File: '%s' Function: '%s'", iTypeId, szRefFileName.c_str(), szRefFuncName.c_str());
#endif
...
#ifdef _DEBUG
	TraceError("CPythonStackController::IsAllowedReference Error - Unknown type: %d", iTypeId);
#endif
}
