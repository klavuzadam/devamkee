...
public:
	...
	DWORD				    		GetThreadCount(SYSTEM_PROCESS_INFORMATION_MY * procInfo);

	SYSTEM_THREAD_INFORMATION_MY  * FindThread(SYSTEM_PROCESS_INFORMATION_MY * procInfo, DWORD dwThreadId);
