...
// #endif
		...
		std::vector<std::unique_ptr<CGrannyLODController>>& GetLODController() { return m_LODControllerVector; }
#endif
	...
	protected:
		bool m_bRenderStatus;
		bool m_bEffectStatus;
	public:
		bool	GetRenderStatus() { return m_bRenderStatus; }
		void	SetRenderStatus(bool bStatus) { m_bRenderStatus = bStatus; }

		bool	GetEffectStatus() { return m_bEffectStatus; }
		void	SetEffectStatus(bool bStatus) { m_bEffectStatus = bStatus; }

		void	ShowAllAttachingEffectEx();
		void	HideAllAttachingEffectEx();
#endif


public:
	bool	IsBoss(){return (m_bRankIndex>=4 ? true : false);}
	BYTE	GetRank(){return m_bRankIndex;}
	void	SetRank(BYTE bNewRank) {m_bRankIndex=bNewRank;}
protected:
	BYTE	m_bRankIndex;
};
