...
//#endif
		...
		{
			return DEF_STR(USE_ADD_BOOSTER_ATTR);
		}
		case USE_CHANGE_BOOSTER_ATTR:
		{
			return DEF_STR(USE_CHANGE_BOOSTER_ATTR);
		}
		case USE_ADD_BOOSTER_TIME:
		{
			return DEF_STR(USE_ADD_BOOSTER_TIME);
		}
//#ifdef USE_CRYSTAL_SYSTEM
		case USE_ADD_ATTR_CRYSTAL:
		{
			return DEF_STR(USE_ADD_ATTR_CRYSTAL);
		}
		case USE_CHANGE_ATTR_CRYSTAL:
		{
			return DEF_STR(USE_CHANGE_ATTR_CRYSTAL);
		}
		case USE_RECHARGE_CRYSTAL:
		{
			return DEF_STR(USE_RECHARGE_CRYSTAL);
		}
//#endif
		default:
		{
