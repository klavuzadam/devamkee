...
#ifdef USE_D3D9
    if (FAILED(ms_lpd3dDevice->CreateTexture(m_wShadowMapSize
                                            , m_wShadowMapSize
                                            , 1
                                            , D3DUSAGE_RENDERTARGET
                                            , D3DFMT_R5G6B5
                                            , D3DPOOL_DEFAULT
                                            , &m_lpCharacterShadowMapTexture
                                            , NULL)))
#else
    if (FAILED(ms_lpd3dDevice->CreateTexture(m_wShadowMapSize
                                            , m_wShadowMapSize
...
bool CMapOutdoor::BeginRenderCharacterShadowToTexture()
{
    ...
    {
        TraceError("CMapOutdoor::BeginRenderCharacterShadowToTexture : Unable to Set Stencil Shadow Map Render Target\n");
    }
