...
void initchr()
{
...
#endif
	PyModule_AddIntConstant(poModule, "AFFECT_NAME_PET", CInstanceBase::AFFECT_NAME_PET);
	PyModule_AddIntConstant(poModule, "AFFECT_NAME_MOUNT", CInstanceBase::AFFECT_NAME_MOUNT);
	PyModule_AddIntConstant(poModule, "AFFECT_NAME_BUFFI", CInstanceBase::AFFECT_NAME_BUFFI);
#ifdef ENABLE_AURA_SYSTEM
	...
	PyModule_AddIntConstant(poModule, "AFFECT_BOHO_PERFECT",						CInstanceBase::AFFECT_BOHO_PERFECT);
	PyModule_AddIntConstant(poModule, "AFFECT_KWAESOK_PERFECT",						CInstanceBase::AFFECT_KWAESOK_PERFECT);
	PyModule_AddIntConstant(poModule, "AFFECT_GICHEON_PERFECT",						CInstanceBase::AFFECT_GICHEON_PERFECT);
	PyModule_AddIntConstant(poModule, "AFFECT_JEUNGRYEOK_PERFECT",						CInstanceBase::AFFECT_JEUNGRYEOK_PERFECT);
#endif
	...
	PyModule_AddIntConstant(poModule, "AFFECT_BUFFI_HOSIN", CInstanceBase::AFFECT_BUFFI_HOSIN);
	PyModule_AddIntConstant(poModule, "AFFECT_BUFFI_GICHEON", CInstanceBase::AFFECT_BUFFI_GICHEON);
	PyModule_AddIntConstant(poModule, "AFFECT_BUFFI_KWAESOK", CInstanceBase::AFFECT_BUFFI_KWAESOK);
	PyModule_AddIntConstant(poModule, "AFFECT_BUFFI_JEUNGRYEO", CInstanceBase::AFFECT_BUFFI_JEUNGRYEO);
#endif
#ifdef ENABLE_WOLFMAN_CHARACTER
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_THIEF",					CInstanceBase::NEW_AFFECT_THIEF);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_EXP",						CInstanceBase::NEW_AFFECT_EXP);
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_BRAVE_CAPE", CInstanceBase::NEW_AFFECT_BRAVE_CAPE);
#endif
...
#endif
	PyModule_AddIntConstant(poModule, "EFFECT_METIN_QUEUE", CInstanceBase::EFFECT_METIN_QUEUE);
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_AUTO_USE", CInstanceBase::NEW_AFFECT_AUTO_USE);
#endif
#ifdef USE_BOOST_POTIONS
	PyModule_AddIntConstant(poModule, "AFFECT_BOOST_POTION1", CInstanceBase::AFFECT_BOOST_POTION1);
	PyModule_AddIntConstant(poModule, "AFFECT_BOOST_POTION2", CInstanceBase::AFFECT_BOOST_POTION2);
	PyModule_AddIntConstant(poModule, "AFFECT_BOOST_POTION3", CInstanceBase::AFFECT_BOOST_POTION3);
#endif

#if defined(__BL_BATTLE_ROYALE__)
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_BATTLE_ROYALE_SLOW", CInstanceBase::NEW_AFFECT_BATTLE_ROYALE_SLOW);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_BATTLE_ROYALE_MOVE_SPEED", CInstanceBase::NEW_AFFECT_BATTLE_ROYALE_MOVE_SPEED);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_BATTLE_ROYALE_INFINITE_STAMINA", CInstanceBase::NEW_AFFECT_BATTLE_ROYALE_INFINITE_STAMINA);
#endif
#ifdef USE_CRYSTAL_SYSTEM
	PyModule_AddIntConstant(poModule, "AFFECT_CRYSTAL", CInstanceBase::AFFECT_CRYSTAL);
#endif
#ifdef USE_PASSIVE_ABILITY_TAMER
	PyModule_AddIntConstant(poModule, "AFFECT_SKILL_TAMER_BOOK_BONUS", CInstanceBase::AFFECT_SKILL_TAMER_BOOK_BONUS);
	PyModule_AddIntConstant(poModule, "AFFECT_SKILL_TAMER_NO_BOOK_DELAY", CInstanceBase::AFFECT_SKILL_TAMER_NO_BOOK_DELAY);
#endif
#ifdef USE_DROP_AFFECT_BONUSES
	PyModule_AddIntConstant(poModule, "AFFECT_DROP_GREEN", CInstanceBase::AFFECT_DROP_GREEN);
	PyModule_AddIntConstant(poModule, "AFFECT_DROP_BLUE", CInstanceBase::AFFECT_DROP_BLUE);
#endif
#ifdef USE_PREMIUM_AFFECT
	PyModule_AddIntConstant(poModule, "AFFECT_PREMIUM_USER", CInstanceBase::AFFECT_PREMIUM_USER);
#endif
}
