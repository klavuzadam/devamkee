...
PyObject * packExist(PyObject * poSelf, PyObject * poArgs)
{
	...
	return Py_BuildValue("i", CEterPackManager::Instance().isExist(strFileName, __FUNCTION__, false)?1:0);
}
...
PyObject * packGet(PyObject * poSelf, PyObject * poArgs)
{
	...
	if (pcExt) // 확장자가 있고
	{
...
#endif
		{
			...
			if (CEterPackManager::Instance().Get(file, strFileName, &pData, __FUNCTION__))
