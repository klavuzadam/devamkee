...
class CPythonMiniMap : public CScreen, public CSingleton<CPythonMiniMap>
{
	...
	bool GetAutoHuntStatus() { return m_bAutoHuntStatus; }
		...
		void CreateBattleRoyaleElectricField();
		void UpdateBattleRoyaleElectricField();
		void RenderBattleRoyaleElectricField();
#endif
...
#if defined(__BL_BATTLE_ROYALE__)
		CGraphicImageInstance			m_AtlasRedCircleImageInstance;
		CGraphicImageInstance			m_AtlasWhiteCircleImageInstance;
#endif
