...
struct SLOCALEDATA
{
	...
	{ LSS_YMIR,		"ymir",			949,	"1234abcd5678efgh"	},		// Korea
	...
	{ LSS_EUROPE,	"ca",			1252,	"1234abcd5678efgh"	},		// Z8Games (Canada)
	{ LSS_EUROPE,	"sg",			1252,	"1234abcd5678efgh"	},		// TEC (Singapore)
	{ LSS_JAPAN,	"japan",		932,	"1234abcd5678efgh"	},		// Japan
	{ LSS_EUROPE,	"br",			1252,	"1234abcd5678efgh"	},		// OnGame (Brazil)
	{ LSS_HONGKONG,	"hongkong",		950,	"1234abcd5678efgh"	},		// HongKong & Taiwan
	{ LSS_NEWCIBN,	"newcibn",		936,	"1234abcd5678efgh"	},		// CIBN (Free world)
	{ LSS_ENGLISH,	"english",		949,	"1234abcd5678efgh"	},		// English (Obsoleted)
	{ LSS_YMIR,		"kr",			949,	"1234abcd5678efgh"	},		// Korea (Obsoleted)
	{ NULL,			NULL,			0,		"1234abcd5678efgh"	}
};
