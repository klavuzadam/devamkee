...
void CInstanceBase::StartWalking()
{
	...
	else if (IsAffect(AFFECT_KWAESOK_PERFECT))
	{
		m_adwCRCAffectEffect[AFFECT_KWAESOK_PERFECT] = __EffectContainer_AttachEffect(EFFECT_AFFECT_KWAESOK_PERFECT);
	}
#endif	
}
...
void CInstanceBase::EndWalking(float fBlendingTime)
{
	...
	if (IsWalking()||!IsAttacked())
	{
		...
		{
			__EffectContainer_DetachEffect(EFFECT_AFFECT_KWAESOK_PERFECT);
		}
#endif	
	}
}
