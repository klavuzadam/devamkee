...
void CNetworkActorManager::UpdateActor(const SNetworkUpdateActorData& c_rkNetUpdateActorData)
{
	...
	if (pkInstFind)
	{
...
#if defined(WJ_COMBAT_ZONE)
		pkInstFind->SetCombatZoneRank(c_rkNetUpdateActorData.combat_zone_rank);
		...
		//pkInstFind->AttachShiningEffect();
#endif
...
#if defined(WJ_COMBAT_ZONE)
	rkNetActorData.combat_zone_rank = c_rkNetUpdateActorData.combat_zone_rank;
