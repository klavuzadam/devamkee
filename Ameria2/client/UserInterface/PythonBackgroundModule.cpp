...
PyObject * backgroundLoadMap(PyObject * poSelf, PyObject * poArgs)
{
	...
	CPythonBackground& rkBG=CPythonBackground::Instance();
	rkBG.LoadMap(pszMapPathName, x, y, z, CPythonSystem::Instance().IsSnowTerrainTexture());
...
PyObject* backgroundIsBattleRoyaleMap(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("b", CPythonBackground::Instance().IsBattleRoyaleMap());
}
#endif
...
void initBackground()
{
	...
	{
#if defined(__BL_BATTLE_ROYALE__)
		{ "IsBattleRoyaleMap",					backgroundIsBattleRoyaleMap,				METH_VARARGS },
#endif
