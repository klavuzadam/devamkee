...
#ifdef ENABLE_EXTENDED_ITEMNAME_ON_GROUND
		void RegisterItemTextTail(DWORD VirtualID, const char * c_szText, int ownerTime, CGraphicObjectInstance * pOwner, const D3DXCOLOR itemColor = D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f));
#else
...
#ifdef ENABLE_EXTENDED_ITEMNAME_ON_GROUND
		void SetItemTextTailOwner(DWORD dwVID, const char * c_szName, bool isRealName = false);
#else
