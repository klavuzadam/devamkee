...
bool CParticleProperty::SetTexture(const char* c_szFileName, float xScale, float yScale)
#else
...
#endif
	m_ImageVectorScale.clear();
	m_ImageVectorScale.emplace_back(xScale, yScale);
...
CParticleProperty & CParticleProperty::operator = ( const CParticleProperty& c_ParticleProperty )
{
	...
	m_ImageVectorScale = c_ParticleProperty.m_ImageVectorScale;
