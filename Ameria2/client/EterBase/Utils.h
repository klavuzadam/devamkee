...
static void SplitString(const std::string_view& c_rString, char szDelimiter, StringFunction stFunc)
{
    std::size_t nFrom = 0;
...
__forceinline static bool IsNumber(const std::string& c_rString)
{
