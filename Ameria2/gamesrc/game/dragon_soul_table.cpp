...
bool DragonSoulTable::GetRefineGradeValues(BYTE ds_type, BYTE grade_idx, OUT int& need_count, OUT int64_t& fee, OUT std::vector<float>& vec_probs)
{
...
bool DragonSoulTable::GetRefineStepValues(BYTE ds_type, BYTE step_idx, OUT int& need_count, OUT int64_t& fee, OUT std::vector<float>& vec_probs)
{
...
bool DragonSoulTable::GetRefineStrengthValues(BYTE ds_type, BYTE material_type, BYTE strength_idx, OUT int64_t& fee, OUT float& prob)
{
