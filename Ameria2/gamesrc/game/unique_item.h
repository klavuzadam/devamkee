...
enum
{
	...
	ITEM_SKILLFORGET2_VNUM = 70055,		// 7, 8 ½ºÅ³ ¸Á°¢¼­

	UNIQUE_ITEM_FISH_MIND = 71008,		// ¿ù°£¾î½É
	UNIQUE_ITEM_SAFEBOX_EXPAND = 71009,		// Ã¢°íÈ®Àå±Ç
	UNIQUE_ITEM_AUTOLOOT_GOLD = 71010,		// Á¦3ÀÇ ¼Õ
	UNIQUE_ITEM_EMOTION_MASK = 71011,	// ¿­Á¤ÀÇ °¡¸é
	UNIQUE_ITEM_EMOTION_MASK2 = 71033,	// ¿­Á¤ÀÇ °¡¸é
	...
	BOOST_POTION_ATTACK_SPEED = 72731,
	BOOST_POTION_MOVE_SPEED = 72732,
#endif
#ifdef USE_CRYSTAL_SYSTEM
	MAGIC_SPIRAL_VNUM = 64035,
#endif
};
