...
const int HORSE_HEALTH_DROP_INTERVAL = INT_MAX;
const int HORSE_STAMINA_CONSUME_INTERVAL = 999 * 999;
const int HORSE_STAMINA_REGEN_INTERVAL = 1 * 1;
 ...
 */
{
	...
	{ 25,	20101,	3,	4,	26,	35,	18,	9,	54,	43,	64,	32 },	// 1 (ÃÊ±Þ)
...
void CHorseRider::FeedHorse()
{
	...
	{
		UpdateHorseHealth(+1);
		// 20050324. ipkn ¸» ¸Ô¿´À»¶§µµ Ã¼·Â °¨¼Ò µô·¹ÀÌ¸¦ ´Ã¸°´Ù.
		ResetHorseHealthDropTime();
	}
}
