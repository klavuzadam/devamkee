...
void EraseIfContainer(ContainerType& container, FuncType func){
	for(auto it = container.begin(); it != container.end();)
		it = func(*it) ? container.erase(it) : ++it;
}
...
namespace ikashop
{
	...
	public:
		...
		static constexpr auto GRID_WIDTH = 10;
		static constexpr auto GRID_HEIGHT = 8;
#else
...
#ifdef USE_IKASHOP_UI_RENEWED
		bool RefreshToOwnerValutes(LPCHARACTER ch);
#endif
