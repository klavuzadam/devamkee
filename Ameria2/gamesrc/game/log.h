...
class LogManager : public singleton<LogManager>
{
	public:
		...
		void		ExchangeItemLog(DWORD tradeID, LPITEM item, const char * player, DWORD pos);
#endif
		...
		void		ShoutLog(BYTE bChannel, BYTE bEmpire, const char * pname, const char * pszText);
#else
		...
		void		KingdomsWarLog(const char * c_pszText);
#endif
