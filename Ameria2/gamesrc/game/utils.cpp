...
void split_argument(const char* argument, std::vector<std::string>& vecArgs, const char* cpszSplit/* = " "*/)
{
	std::string arg = argument;
	boost::split(vecArgs, arg, boost::is_any_of(cpszSplit), boost::token_compress_on);
}
