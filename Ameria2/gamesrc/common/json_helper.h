...
namespace jsonHelper
{
	...
	inline void insertValue(rapidjson::Value& value, const std::string& key, const int& insertValue, rapidjson::MemoryPoolAllocator<>& allocator) {
	...
	inline void insertValue(rapidjson::Value& value, const std::string& key, const int64_t& insertValue, rapidjson::MemoryPoolAllocator<>& allocator) {
		assert(value.IsObject());
		rapidjson::Value keyValue;
		keyValue.SetString(key.c_str(), allocator);
		rapidjson::Value newValue;
	...
	inline void insertValue(rapidjson::Value& value, const std::string& key, const std::string& insertValue, rapidjson::MemoryPoolAllocator<>& allocator) {
		assert(value.IsObject());
		rapidjson::Value keyValue;
		keyValue.SetString(key.c_str(), allocator);
		rapidjson::Value newValue;
