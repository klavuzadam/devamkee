...
itemShopCategoryData = {
    ...
    5:{
        ...
        "subCategory":[localeInfo.CATEGORY_5_SUB_0_NAME,localeInfo.CATEGORY_5_SUB_1_NAME,localeInfo.CATEGORY_5_SUB_2_NAME,localeInfo.CATEGORY_5_SUB_3_NAME,localeInfo.CATEGORY_5_SUB_4_NAME,localeInfo.CATEGORY_5_SUB_5_NAME],
        },
    6:{
...
class ItemShopWindow(ui.Window):
    ...
    def WheelBtn(self):
        webbrowser.open_new("https://ameria.to/gateway")
