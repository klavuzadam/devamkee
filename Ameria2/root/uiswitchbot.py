...
class SwitchbotItemTab(ui.ThinBoardCircle):
	...
	def __LoadItemTab(self):	
		...
		self.selectButton.SetUpVisual("poza/switchbot/btn_small_01.sub")
		self.selectButton.SetOverVisual("poza/switchbot/btn_small_02.sub")
		self.selectButton.SetDownVisual("poza/switchbot/btn_small_03.sub")
		self.selectButton.SetDisableVisual("poza/switchbot/btn_small_01.sub")
...
class SwitchbotAttribute(ui.Window):
	...
	def Create(self, width, index):
		...
		self.searchTypeButton.SetUpVisual("poza/switchbot/search_attr_01.sub")
		self.searchTypeButton.SetOverVisual("poza/switchbot/search_attr_02.sub")
		self.searchTypeButton.SetDownVisual("poza/switchbot/search_attr_03.sub")
		self.searchTypeButton.SetDisableVisual("poza/switchbot/search_attr_03.sub")
		...
		self.deleteAttributeButton.SetUpVisual("poza/switchbot/delete_attr_01.sub")
		self.deleteAttributeButton.SetOverVisual("poza/switchbot/delete_attr_02.sub")
		self.deleteAttributeButton.SetDownVisual("poza/switchbot/delete_attr_03.sub")
		self.deleteAttributeButton.SetDisableVisual("poza/switchbot/delete_attr_03.sub")
...
class SwitchbotWindow(ui.BoardWithTitleBar):
	...
	def __LoadWindow(self):
		...
		for i in xrange(switchbot.ALTERNATIVE_COUNT):
			...
			alternativeButton.SetUpVisual("poza/switchbot/btn_small_01.sub")
			alternativeButton.SetOverVisual("poza/switchbot/btn_small_02.sub")
			alternativeButton.SetDownVisual("poza/switchbot/btn_small_03.sub")
			alternativeButton.SetDisableVisual("poza/switchbot/btn_small_03.sub")
			...
			if constInfo.ENABLE_ALTERNATIVE_SWITCHBOT:
				if not constInfo.HAS_PREMIUM_SWITCHBOT and i >= 2:
		...
		self.saveButton.SetUpVisual("poza/switchbot/save_attr_01.sub")
		self.saveButton.SetOverVisual("poza/switchbot/save_attr_02.sub")
		self.saveButton.SetDownVisual("poza/switchbot/save_attr_03.sub")
		self.saveButton.SetDisableVisual("poza/switchbot/save_attr_03.sub")
		...
		self.startButton.SetUpVisual("poza/switchbot/btn_big_01.sub")
		self.startButton.SetOverVisual("poza/switchbot/btn_big_02.sub")
		self.startButton.SetDownVisual("poza/switchbot/btn_big_03.sub")
		self.startButton.SetDisableVisual("poza/switchbot/btn_big_03.sub")
		...
		self.stopButton.SetUpVisual("poza/switchbot/btn_big_01.sub")
		self.stopButton.SetOverVisual("poza/switchbot/btn_big_02.sub")
		self.stopButton.SetDownVisual("poza/switchbot/btn_big_03.sub")
		self.stopButton.SetDisableVisual("poza/switchbot/btn_big_03.sub")
	...
	if constInfo.ENABLE_ALTERNATIVE_SWITCHBOT:
		def RefreshPremiumSwitchbot(self):
			for i in xrange(switchbot.ALTERNATIVE_COUNT):
				if not constInfo.HAS_PREMIUM_SWITCHBOT and i >= 2:
...
class ConfigurationWindow(ui.BoardWithTitleBar):
	...
	class ConfigurationLine(ui.Window):
		...
		def __init__(self, width):
			...
			self.loadButton.SetUpVisual("poza/switchbot/load_attr_01.sub")
			self.loadButton.SetOverVisual("poza/switchbot/load_attr_02.sub")
			self.loadButton.SetDownVisual("poza/switchbot/load_attr_03.sub")
			self.loadButton.SetDisableVisual("poza/switchbot/load_attr_03.sub")
			...
			self.deleteButton.SetUpVisual("poza/switchbot/delete_attr_01.sub")
			self.deleteButton.SetOverVisual("poza/switchbot/delete_attr_02.sub")
			self.deleteButton.SetDownVisual("poza/switchbot/delete_attr_03.sub")
			self.deleteButton.SetDisableVisual("poza/switchbot/delete_attr_03.sub")
	...
	def __LoadWindow(self):
		...
		self.saveButton.SetUpVisual("poza/switchbot/btn_small_01.sub")
		self.saveButton.SetOverVisual("poza/switchbot/btn_small_02.sub")
		self.saveButton.SetDownVisual("poza/switchbot/btn_small_03.sub")
		self.saveButton.SetDisableVisual("poza/switchbot/btn_small_01.sub")
