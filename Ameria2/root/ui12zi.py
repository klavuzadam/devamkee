...
class FloorLimitTimeWindow(ui.ScriptWindow):
    ...
    def __LoadWindow(self):
        try:
            pyScrLoader = ui.PythonScriptLoader()
            pyScrLoader.LoadScriptFile(self, "UIScript/FloorInfo.py")

        except:
            import exception
            exception.Abort("FloorLimitTimeWindow.__LoadWindow.UIScript/FloorInfo.py")
    ...
    def DayorNigh12zi(self):
        if constInfo.ZodiacDayorNight == 0:
            background.RegisterEnvironmentData(2, "d:/ymir work/environment/moonlight04.msenv")
...
class Reward12ziWindow(ui.ScriptWindow):
    ...
    def __LoadWindow(self):
        try:
            ...
            import exception
            exception.Abort("Reward12ziWindow.__LoadWindow.UIScript/ziRewardWindow.py")
