...
window = {
	"name" : "BattleRoyaleApplicationWindow",
	"style" : ("movable", ),
	...
	[
		{
			...
			"width"		: WINDOW_WIDTH,
			"height"	: WINDOW_HEIGHT,
			"title"		: uiScriptLocale.BATTLE_ROYALE_APPLICATION_TITLE,
			...
			[
				...
				
				{
					...
					"x"				: 10,
					"y"				: 35,
					"text"			: uiScriptLocale.BATTLE_ROYALE_MAINBUTTON_RANKING,
				...
				
				{
					...
					"x"				: 0,
					"y"				: 35,
					"text"			: uiScriptLocale.BATTLE_ROYALE_MAINBUTTON_APPLICATION,
					"vertical_align"	: "bottom",
