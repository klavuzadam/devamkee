...
window = {
	...
	(
		...
		},
		{
			...
			"horizontal_align" : "center",
			"vertical_align" : "bottom",
			"tooltip_text" : uiScriptLocale.MESSENGER_BLOCK,
			"tooltip_x" : 0,
			"tooltip_y" : 35,

			"default_image" : flamewindPath.GetPublic("block_button1"),
			"over_image" : flamewindPath.GetPublic("block_button2"),
			"down_image" : flamewindPath.GetPublic("block_button3"),
			"disable_image" : flamewindPath.GetPublic("block_button4"),
		},
		{
			"name" : "WhisperButton",
			"type" : "button",
