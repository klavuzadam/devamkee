...
class PartyWindow(ui.Window):
	...
	def __init__(self):
		...
		eventManager.EventManager().add_observer(uiAffectBar.EVENT_ARRANGE_AFFECT_LIST, self.OnArrangeAffectList)
	...
	def OnArrangeAffectList(self, width, height):
		self.SetPosition(10, max(52, 8 + height + 16))
