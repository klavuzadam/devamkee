...
class CGrannyModelInstance : public CGraphicCollisionObject
{
	...
	public:
		...
		// Custom transform handler
		void	SetScale(const D3DVECTOR& scale, const D3DVECTOR& scale_pos) { _scale = scale; _scalePos = scale_pos; }
		void	SetRotation(const D3DVECTOR& rotation) { _eulerAngles = rotation; }
...
#error "unknown granny version"
	...
	protected:
		...
		// TransformData
		D3DXVECTOR3 _scale;
		D3DXVECTOR3 _scalePos;
		D3DXVECTOR3 _eulerAngles;

#ifdef _TEST
		D3DXMATRIX TEST_matWorld;
#endif

		SMaterialData material_data;
