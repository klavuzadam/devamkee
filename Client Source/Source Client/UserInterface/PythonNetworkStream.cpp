...
class CMainPacketHeaderMap : public CNetworkPacketHeaderMap
{
	...
	public:
		CMainPacketHeaderMap()
		{
			...
			Set(HEADER_GC_SET_GOLD, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCGoldUpdate), STATIC_SIZE_PACKET));
			Set(HEADER_GC_UPDATE_GOLD, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCGoldUpdate), STATIC_SIZE_PACKET));

			Set(HEADER_GC_BUSY_ACTION, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCBusyAction), STATIC_SIZE_PACKET));
			Set(HEADER_GC_REQUEST_INFO, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCRequestInfo), STATIC_SIZE_PACKET));
			...
			Set(HEADER_GC_SPECIAL_SHOP, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCSpecialShop), DYNAMIC_SIZE_PACKET));
			Set(HEADER_GC_NPC_INFO_BOARD, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketCGNpcInfoBoard), DYNAMIC_SIZE_PACKET));
			...
			Set(HEADER_GC_TARGET,		CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCTarget), DYNAMIC_SIZE_PACKET));
			...
			Set(HEADER_GC_ADD_FLY_SHOOT_TARGETING, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCFlyTargeting), STATIC_SIZE_PACKET));
			Set(HEADER_GC_CLEAR_FLY_SHOOT_TARGETING, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCFlyClearTargeting), STATIC_SIZE_PACKET));
			...
			Set(HEADER_GC_FISHING_GAME, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCFishingGame), DYNAMIC_SIZE_PACKET));
			...
			Set(HEADER_GC_SPECIAL_FLAG, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCSpecialFlag), STATIC_SIZE_PACKET));
...
void CPythonNetworkStream::PingPort(const char* c_szAddr, UINT uPort)
{
	CNetworkStream::PingPort(c_szAddr, uPort);
}
...
bool CPythonNetworkStream::CheckPacket(TPacketHeader * pRetHeader)
{
	*pRetHeader = 0;
...
#endif
	{
		...
		{
			Tracef("CPythonNetworkStream::CheckPacket - Not enough dynamic packet size: header %d packet size: %d < %d\n",
		...
		{
			Tracef("CPythonNetworkStream::CheckPacket - Not enough LARGE dynamic packet size: header %d packet size: %d < %d\n",
