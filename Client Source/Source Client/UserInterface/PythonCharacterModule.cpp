...
void initchr()
{
	...
	PyModule_AddIntConstant(poModule, "PART_WEAPON",						CRaceData::EQUIP_PART_WEAPON);
	PyModule_AddIntConstant(poModule, "PART_HEAD",							CRaceData::EQUIP_PART_HEAD);
	PyModule_AddIntConstant(poModule, "PART_WEAPON_LEFT",					CRaceData::EQUIP_PART_WEAPON_LEFT);
#ifdef ENABLE_ACCE_COSTUME_SYSTEM
	PyModule_AddIntConstant(poModule, "PART_ACCE",							CRaceData::EQUIP_PART_ACCE);
#endif
	/////

	PyModule_AddIntConstant(poModule, "AFFECT_POISON", AFFECT_POISON);
	PyModule_AddIntConstant(poModule, "AFFECT_FIRE", AFFECT_FIRE);
	PyModule_AddIntConstant(poModule, "AFFECT_SLOW", AFFECT_SLOW);
	PyModule_AddIntConstant(poModule, "AFFECT_STUN", AFFECT_STUN);
	PyModule_AddIntConstant(poModule, "AFFECT_ROOT", AFFECT_ROOT);
	PyModule_AddIntConstant(poModule, "AFFECT_HEAL_ON_DAMAGE", AFFECT_HEAL_ON_DAMAGE);
	PyModule_AddIntConstant(poModule, "AFFECT_REMOVE_ALL_RESIST", AFFECT_REMOVE_ALL_RESIST);
	PyModule_AddIntConstant(poModule, "AFFECT_MOV_SPEED_POTION", AFFECT_MOV_SPEED);
	PyModule_AddIntConstant(poModule, "AFFECT_ATT_SPEED_POTION", AFFECT_ATT_SPEED);
	PyModule_AddIntConstant(poModule, "AFFECT_FISH_MIND", AFFECT_FISH_MIND_PILL);

	PyModule_AddIntConstant(poModule, "AFFECT_CHINA_FIREWORK", AFFECT_CHINA_FIREWORK);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_MALL", AFFECT_MALL);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_NO_DEATH_PENALTY", AFFECT_NO_DEATH_PENALTY);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SKILL_BOOK_BONUS", AFFECT_SKILL_BOOK_BONUS);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SKILL_BOOK_NO_DELAY", AFFECT_SKILL_NO_BOOK_DELAY);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_EXP_BONUS", AFFECT_EXP_BONUS);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_EXP_BONUS_EURO_FREE", AFFECT_EXP_BONUS_EURO_FREE);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_EXP_BONUS_EURO_FREE_UNDER_15", AFFECT_EXP_BONUS_EURO_FREE_UNDER_15);

	PyModule_AddIntConstant(poModule, "NEW_AFFECT_ITEM_BONUS", AFFECT_ITEM_BONUS);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SAFEBOX", AFFECT_SAFEBOX);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_AUTOLOOT", AFFECT_AUTOLOOT);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_FISH_MIND", AFFECT_FISH_MIND);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_MARRIAGE_FAST", AFFECT_MARRIAGE_FAST);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_GOLD_BONUS", AFFECT_GOLD_BONUS);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SHOP_PREMIUM", AFFECT_SHOP_PREMIUM);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SUBSCRIPTION", AFFECT_PREMIUM_SUBSCRIPTION);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_AUTO_HP_RECOVERY", AFFECT_AUTO_HP_RECOVERY);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_AUTO_SP_RECOVERY", AFFECT_AUTO_SP_RECOVERY);

	PyModule_AddIntConstant(poModule, "NEW_AFFECT_DRAGON_SOUL_QUALIFIED", AFFECT_DRAGON_SOUL_QUALIFIED);

	PyModule_AddIntConstant(poModule, "NEW_AFFECT_DRAGON_SOUL_DECK1", AFFECT_DRAGON_SOUL_DECK_0);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_DRAGON_SOUL_DECK2", AFFECT_DRAGON_SOUL_DECK_1);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_POLYMORPH", AFFECT_POLYMORPH);
	PyModule_AddIntConstant(poModule, "AFFECT_SPRINT", AFFECT_SPRINT);
	PyModule_AddIntConstant(poModule, "AFFECT_BLOODTHIRST", AFFECT_BLOODTHIRST);
	PyModule_AddIntConstant(poModule, "AFFECT_DEBUFF_HEAVEN_PROTECTION", AFFECT_DEBUFF_HEAVEN_PROTECTION);
	PyModule_AddIntConstant(poModule, "AFFECT_TEMPLE_CURSE", AFFECT_TEMPLE_CURSE);
	PyModule_AddIntConstant(poModule, "AFFECT_DEVILTOWER_DAMAGE", AFFECT_DEVILTOWER_DAMAGE);
	PyModule_AddIntConstant(poModule, "AFFECT_COLLECT_NO_TIME", AFFECT_COLLECT_NO_TIME);
	PyModule_AddIntConstant(poModule, "AFFECT_COLLECT_NO_FAIL_TIME", AFFECT_COLLECT_NO_FAIL_TIME);
	PyModule_AddIntConstant(poModule, "AFFECT_LEARN_NO_FAIL_TIME", AFFECT_LEARN_NO_FAIL_TIME);
	PyModule_AddIntConstant(poModule, "AFFECT_EXP_BLOCK", AFFECT_EXP_BLOCK);
	PyModule_AddIntConstant(poModule, "AFFECT_POTION_GENERAL_USE", AFFECT_POTION_GENERAL_USE);
	PyModule_AddIntConstant(poModule, "AFFECT_POTION_BOOST", AFFECT_POTION_BOOST);
	PyModule_AddIntConstant(poModule, "AFFECT_POTION_FOOD", AFFECT_POTION_FOOD);
	PyModule_AddIntConstant(poModule, "AFFECT_POTION_OFFENSIVE", AFFECT_POTION_OFFENSIVE);
	PyModule_AddIntConstant(poModule, "AFFECT_POTION_DEFENSIVE", AFFECT_POTION_DEFENSIVE);
	PyModule_AddIntConstant(poModule, "AFFECT_HERBALIST_BONUS", AFFECT_HERBALIST_BONUS);
	PyModule_AddIntConstant(poModule, "AFFECT_MONKEY_CURSE_EASY", AFFECT_MONKEY_CURSE_EASY);
	PyModule_AddIntConstant(poModule, "AFFECT_MONKEY_CURSE_NORMAL", AFFECT_MONKEY_CURSE_NORMAL);
	PyModule_AddIntConstant(poModule, "AFFECT_MONKEY_CURSE_HARD", AFFECT_MONKEY_CURSE_HARD);
	PyModule_AddIntConstant(poModule, "AFFECT_FAST_PICKUP", AFFECT_FAST_PICKUP);
	PyModule_AddIntConstant(poModule, "AFFECT_HEAVEN_PROTECTION", AFFECT_HEAVEN_PROTECTION);
	PyModule_AddIntConstant(poModule, "AFFECT_NO_ITEM_DEATH_PENALTY", AFFECT_NO_ITEM_DEATH_PENALTY);

	PyModule_AddIntConstant(poModule, "AFF_YMIR", AFF_YMIR);
	PyModule_AddIntConstant(poModule, "AFF_INVISIBILITY", AFF_INVISIBILITY);
	PyModule_AddIntConstant(poModule, "AFF_SPAWN", AFF_SPAWN);
	PyModule_AddIntConstant(poModule, "AFF_POISON", AFF_POISON);
	PyModule_AddIntConstant(poModule, "AFF_SLOW", AFF_SLOW);
	PyModule_AddIntConstant(poModule, "AFF_STUN", AFF_STUN);
	PyModule_AddIntConstant(poModule, "AFF_ROOT", AFF_ROOT);
	PyModule_AddIntConstant(poModule, "AFF_DUNGEON_READY", AFF_DUNGEON_READY);
	PyModule_AddIntConstant(poModule, "AFF_DUNGEON_UNIQUE", AFF_DUNGEON_UNIQUE);
	PyModule_AddIntConstant(poModule, "AFF_SHOW_ALWAYS", AFF_SHOW_ALWAYS);
	PyModule_AddIntConstant(poModule, "AFF_BUILDING_CONSTRUCTION_SMALL", AFF_BUILDING_CONSTRUCTION_SMALL);
	PyModule_AddIntConstant(poModule, "AFF_BUILDING_CONSTRUCTION_LARGE", AFF_BUILDING_CONSTRUCTION_LARGE);
	PyModule_AddIntConstant(poModule, "AFF_BUILDING_UPGRADE", AFF_BUILDING_UPGRADE);
	PyModule_AddIntConstant(poModule, "AFF_MOV_SPEED_POTION", AFF_MOV_SPEED_POTION);
	PyModule_AddIntConstant(poModule, "AFF_ATT_SPEED_POTION", AFF_ATT_SPEED_POTION);
	PyModule_AddIntConstant(poModule, "AFF_FISH_MIND", AFF_FISH_MIND);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_BERSERK", AFF_SKILL_BERSERK);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_SWORD_AURA", AFF_SKILL_SWORD_AURA);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_STRONG_BODY", AFF_SKILL_STRONG_BODY);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_FEATHER_WALK", AFF_SKILL_FEATHER_WALK);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_STEALTH", AFF_SKILL_STEALTH);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_ENCHANTED_BLADE", AFF_SKILL_ENCHANTED_BLADE);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_TERROR", AFF_SKILL_TERROR);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_ENCHANTED_ARMOR", AFF_SKILL_ENCHANTED_ARMOR);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_BLESSING", AFF_SKILL_BLESSING);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_REFLECT", AFF_SKILL_REFLECT);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_SWIFTNESS", AFF_SKILL_SWIFTNESS);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_MANASHIELD", AFF_SKILL_MANASHIELD);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_FLAME_SPIRIT", AFF_SKILL_FLAME_SPIRIT);
	PyModule_AddIntConstant(poModule, "AFF_REVIVE_INVISIBLE", AFF_REVIVE_INVISIBLE);
	PyModule_AddIntConstant(poModule, "AFF_FIRE", AFF_FIRE);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_DRAGON_HELP", AFF_SKILL_DRAGON_HELP);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_ATTACK_UP", AFF_SKILL_ATTACK_UP);
	PyModule_AddIntConstant(poModule, "AFF_CHARGE_DASH", AFF_CHARGE_DASH);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_DISPEL", AFF_SKILL_DISPEL);
	PyModule_AddIntConstant(poModule, "AFF_SKILL_STRONG_BODY_WITH_FALL", AFF_SKILL_STRONG_BODY_WITH_FALL);
	PyModule_AddIntConstant(poModule, "AFF_POLYMORPH", AFF_POLYMORPH);
	PyModule_AddIntConstant(poModule, "AFF_WAR_FLAG1", AFF_WAR_FLAG1);
	PyModule_AddIntConstant(poModule, "AFF_WAR_FLAG2", AFF_WAR_FLAG2);
	PyModule_AddIntConstant(poModule, "AFF_WAR_FLAG3", AFF_WAR_FLAG3);
	PyModule_AddIntConstant(poModule, "AFF_CHINA_FIREWORK", AFF_CHINA_FIREWORK);
	PyModule_AddIntConstant(poModule, "AFF_HAIR", AFF_HAIR);
	PyModule_AddIntConstant(poModule, "AFF_SPRINT", AFF_SPRINT);
	PyModule_AddIntConstant(poModule, "AFF_SPRINT_HORSE", AFF_SPRINT_HORSE);
	PyModule_AddIntConstant(poModule, "AFF_BLOODTHIRST", AFF_BLOODTHIRST);
	PyModule_AddIntConstant(poModule, "AFF_HEAVEN_PROTECTION", AFF_HEAVEN_PROTECTION);
	PyModule_AddIntConstant(poModule, "AFF_FIRE_RAGE", AFF_FIRE_RAGE);
	PyModule_AddIntConstant(poModule, "AFF_DEMONIC_SPIRIT", AFF_DEMONIC_SPIRIT);
	PyModule_AddIntConstant(poModule, "AFF_QUEST_BOX", AFF_QUEST_BOX);
}
