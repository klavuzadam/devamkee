...
PyObject* imeIsCaptureInput(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonIME::Instance().IsCaptureEnabled());
}
...
void initime()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "IsCaptureInput",			imeIsCaptureInput,			METH_VARARGS },
