...
public:
	...
	void CreateShopTargetEffect(DWORD dwID, DWORD dwShopVID);
	...
	DWORD GetShopTargetCount() { return m_kMap_dwTargetID_dwShopID.size(); }
...
private:
	...
	std::map<DWORD, DWORD> m_kMap_dwTargetID_dwShopID;
