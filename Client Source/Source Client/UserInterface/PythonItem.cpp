...
void CPythonItem::CreateItem(DWORD dwVirtualID, DWORD dwVirtualNumber, float x, float y, float z, bool bDrop, ITEM_COUNT count, bool bIsAttr)
{
	//CItemManager& rkItemMgr=CItemManager::Instance();
