...
void CPythonSafeBox::OpenSafeBox(int iSize)
{
	...
	m_ItemInstanceVector.resize(SAFEBOX_PAGE_WIDTH * SAFEBOX_PAGE_HEIGHT * iSize);
...
void CPythonSafeBox::OpenMall(int iSize)
{
	...
	m_MallItemInstanceVector.resize(SAFEBOX_PAGE_WIDTH * SAFEBOX_PAGE_HEIGHT * iSize);
...
void initsafebox()
{
	...
	PyModule_AddIntConstant(poModule, "SAFEBOX_SLOT_X_COUNT", SAFEBOX_PAGE_WIDTH);
	PyModule_AddIntConstant(poModule, "SAFEBOX_SLOT_Y_COUNT", SAFEBOX_PAGE_HEIGHT);
	PyModule_AddIntConstant(poModule, "SAFEBOX_PAGE_SIZE", SAFEBOX_PAGE_HEIGHT * SAFEBOX_PAGE_WIDTH);
	PyModule_AddIntConstant(poModule, "SAFEBOX_MAX_NUM", SAFEBOX_MAX_NUM);
}
