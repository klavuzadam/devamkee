...
class IAbstractPlayer : public TAbstractSingleton<IAbstractPlayer>
{
	public:
		...
		virtual void	SetItemCount(TItemPos itemPos, ITEM_COUNT byCount) = 0;
		...
		virtual ITEM_COUNT	GetItemCount(TItemPos itemPos) = 0;
		...
		virtual void	SetSprintSkillFlag(BOOL bFlag) = 0;
