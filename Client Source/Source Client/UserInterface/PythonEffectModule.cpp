...
void initeffect()
{
	...
	PyModule_AddIntConstant(poModule, "FLY_FIREWORK_CHRISTMAS", FLY_FIREWORK_CHRISTMAS);
	...
	PyModule_AddIntConstant(poModule, "FLY_SKILL_FLAME_SPIRIT",		FLY_FIREWORK_CHRISTMAS);
