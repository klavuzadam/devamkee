...
#pragma pack(pop)
		...
		typedef std::map<DWORD, std::string> TNonPlayerLocaleNameMap;
	...
	public:
		...
		bool				LoadNonPlayerNames(const char * c_szFileName);
	...
	protected:
		...
		TNonPlayerLocaleNameMap	m_NonPlayerLocaleNameMap;
};
