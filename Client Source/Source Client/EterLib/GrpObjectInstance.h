...
class CGraphicObjectInstance : public CGraphicCollisionObject
{
	...
	public:
		...
		void					SetScale(float x, float y, float z, bool canChangeScale = false);
	...
	public:
		...
		std::shared_ptr<CBaseCollisionInstance>	GetCollisionInstanceData(DWORD dwIndex);
