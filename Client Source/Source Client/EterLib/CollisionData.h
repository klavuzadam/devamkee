...
class CBaseCollisionInstance
{
	public:
		...
		static std::shared_ptr<CBaseCollisionInstance> BuildCollisionInstance(const CStaticCollisionData * c_pCollisionData, const D3DXMATRIX * pMat);
...
typedef std::vector<std::shared_ptr<CBaseCollisionInstance>> CCollisionInstanceVector;
