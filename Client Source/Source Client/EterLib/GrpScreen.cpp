...
void CScreen::RenderBar3d(float sx, float sy, float sz, float ex, float ey, float ez)
{
	...
	{
		{ sx - .5f, sy - .5f, sz, ms_diffuseColor, 0.0f, 0.0f },
		{ sx - .5f, ey - .5f, ez, ms_diffuseColor, 0.0f, 0.0f },
		{ ex - .5f, sy - .5f, sz, ms_diffuseColor, 0.0f, 0.0f },
		{ ex - .5f, ey - .5f, ez, ms_diffuseColor, 0.0f, 0.0f },
	};

	DWORD prevMultisampleAntialias;
	STATEMANAGER.GetRenderState(D3DRS_MULTISAMPLEANTIALIAS, &prevMultisampleAntialias);
	...
	STATEMANAGER.SetRenderState(D3DRS_MULTISAMPLEANTIALIAS, prevMultisampleAntialias);
}
