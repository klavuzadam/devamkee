...
int CGraphicDevice::Create(HWND hWnd, int iHres, int iVres, int realHRes, int realVRes, bool Windowed, int /*iBit*/, int iReflashRate, int iMultisamplingLevel)
{
	int iRet = CREATE_OK;
...
RETRY:
	...
	ms_d3dPresentParameter.BackBufferWidth					= realHRes;
	ms_d3dPresentParameter.BackBufferHeight					= realVRes;
