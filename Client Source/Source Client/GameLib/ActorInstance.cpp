...
void CActorInstance::SetInvisible(bool isInvisible)
{
...
void CActorInstance::SetRoot(bool isRoot)
{
	m_isRoot = isRoot;
	Stop();
}
...
bool CActorInstance::IsAOE()
{
	if (TYPE_AOE == m_eActorType)
		return true;

	return false;
}

bool CActorInstance::IsHerb()
{
	return m_eRace >= 20601 && m_eRace <= 20644;
}
...
BOOL CActorInstance::IsInvisible()
{
