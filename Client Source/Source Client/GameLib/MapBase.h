...
class CMapBase : public CScreen
{
	...
	public:
		...
		void SetPath(const std::string& cr_strPath) { m_strPath = cr_strPath; }
		...
		const std::string& GetMapDataDirectory() const { return IsCopiedMap() ? m_strParentMapName : m_strPath; }
