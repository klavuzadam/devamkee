...
class CRaceData
{
	...
	public:
		...
		void SetScale(float x, float y, float z) { m_scaleData.scaleX = x; m_scaleData.scaleY = y; m_scaleData.scaleZ = z; }
		SScale GetScale() { return m_scaleData; }
