...
class CMapManager : public CScreen, public IPhysicsWorld
{
	public:
		...
		virtual bool			LoadMap(const std::string & c_rstrMapName, const std::string& c_rstrPathName, float x, float y, float z);
		bool					UnloadMap(const std::string c_strMapPath);
